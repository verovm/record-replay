...
type SubstateMessageJSON struct {
	...
	GasFeeCap *math.HexOrDecimal256 `json:"gasFeeCap" gencodec:"required"`
	GasTipCap *math.HexOrDecimal256 `json:"gasTipCap" gencodec:"required"`
	...
	AccessList hexutil.Bytes `json:"accessList" gencodec:"required"`
}
...
func NewSubstateMessageJSON(msg *SubstateMessage) *SubstateMessageJSON {
	...
	msgJSON.AccessList, _ = json.Marshal(msg.AccessList)
...
func (msg *SubstateMessage) SetJSON(msgJSON *SubstateMessageJSON) {
	...
	_ = json.Unmarshal(msgJSON.AccessList, &msg.AccessList)
}
