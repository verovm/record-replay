...
type Substate struct {
	...
	InputAlloc  []*Substate_AllocEntry `protobuf:"bytes,1,rep,name=input_alloc,json=inputAlloc" json:"input_alloc,omitempty"`
	OutputAlloc []*Substate_AllocEntry `protobuf:"bytes,2,rep,name=output_alloc,json=outputAlloc" json:"output_alloc,omitempty"`
...
func (x *Substate) GetInputAlloc() []*Substate_AllocEntry {
	if x != nil {
		return x.InputAlloc
	}
	return nil
...
func (x *Substate) GetOutputAlloc() []*Substate_AllocEntry {
	if x != nil {
...
type Substate_AllocEntry struct {
	...
	Account *Substate_Account `protobuf:"bytes,2,opt,name=account" json:"account,omitempty"`
}
...
type Substate_BlockEnv struct {
	...
	BaseFee     []byte                              `protobuf:"bytes,7,opt,name=base_fee,json=baseFee" json:"base_fee,omitempty"`
	Random      []byte                              `protobuf:"bytes,8,opt,name=random" json:"random,omitempty"`
}
...
func (x *Substate_BlockEnv) GetBaseFee() []byte {
	if x != nil {
		return x.BaseFee
	}
	return nil
...
func (x *Substate_BlockEnv) GetRandom() []byte {
	if x != nil {
		return x.Random
	}
	return nil
...
type Substate_TxMessage struct {
	...
	Nonce *uint64 `protobuf:"varint,1,req,name=nonce" json:"nonce,omitempty"`
	// bool check_nonce = 2;
	GasPrice []byte  `protobuf:"bytes,3,req,name=gas_price,json=gasPrice" json:"gas_price,omitempty"`
	Gas      *uint64 `protobuf:"varint,4,req,name=gas" json:"gas,omitempty"`
	From     []byte  `protobuf:"bytes,5,req,name=from" json:"from,omitempty"`
	To       []byte  `protobuf:"bytes,6,opt,name=to" json:"to,omitempty"`
	Value    []byte  `protobuf:"bytes,7,req,name=value" json:"value,omitempty"`
	...
	GasFeeCap  []byte                                `protobuf:"bytes,11,opt,name=gas_fee_cap,json=gasFeeCap" json:"gas_fee_cap,omitempty"`
	GasTipCap  []byte                                `protobuf:"bytes,12,opt,name=gas_tip_cap,json=gasTipCap" json:"gas_tip_cap,omitempty"`
}
...
func (x *Substate_TxMessage) GetTo() []byte {
	if x != nil {
		return x.To
	}
	return nil
...
func (x *Substate_TxMessage) GetGasFeeCap() []byte {
	if x != nil {
		return x.GasFeeCap
	}
	return nil
...
func (x *Substate_TxMessage) GetGasTipCap() []byte {
	if x != nil {
		return x.GasTipCap
	}
	return nil
...
type Substate_TxMessage_Data struct {
	Data []byte `protobuf:"bytes,8,opt,name=data,oneof"`
}

type Substate_TxMessage_InitCodeHash struct {
	InitCodeHash []byte `protobuf:"bytes,9,opt,name=init_code_hash,json=initCodeHash,oneof"`
}
...
type Substate_Result struct {
	...
	ContractAddress []byte                 `protobuf:"bytes,4,req,name=contract_address,json=contractAddress" json:"contract_address,omitempty"`
	GasUsed         *uint64                `protobuf:"varint,5,req,name=gas_used,json=gasUsed" json:"gas_used,omitempty"`
}
...
func (x *Substate_Result) GetContractAddress() []byte {
	if x != nil {
...
func (*Substate_BlockEnv_BlockHashEntry) Descriptor() ([]byte, []int) {
	return file_substate_proto_rawDescGZIP(), []int{0, 2, 0}
}
...
var file_substate_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x61, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2e, 0x2f, 0x72, 0x65, 0x73, 0x65, 0x61, 0x72,
	0x63, 0x68,
}
...
var file_substate_proto_goTypes = []interface{}{
	(*Substate)(nil),                           // 0: research.Substate
	(*Substate_Account)(nil),                   // 1: research.Substate.Account
	(*Substate_AllocEntry)(nil),                // 2: research.Substate.AllocEntry
	(*Substate_BlockEnv)(nil),                  // 3: research.Substate.BlockEnv
	(*Substate_TxMessage)(nil),                 // 4: research.Substate.TxMessage
	(*Substate_Result)(nil),                    // 5: research.Substate.Result
	(*Substate_Account_StorageEntry)(nil),      // 6: research.Substate.Account.StorageEntry
	(*Substate_BlockEnv_BlockHashEntry)(nil),   // 7: research.Substate.BlockEnv.BlockHashEntry
	(*Substate_TxMessage_AccessListEntry)(nil), // 8: research.Substate.TxMessage.AccessListEntry
	(*Substate_Result_Log)(nil),                // 9: research.Substate.Result.Log
}
var file_substate_proto_depIdxs = []int32{
	2,  // 0: research.Substate.input_alloc:type_name -> research.Substate.AllocEntry
	2,  // 1: research.Substate.output_alloc:type_name -> research.Substate.AllocEntry
	3,  // 2: research.Substate.block_env:type_name -> research.Substate.BlockEnv
	4,  // 3: research.Substate.tx_message:type_name -> research.Substate.TxMessage
	5,  // 4: research.Substate.result:type_name -> research.Substate.Result
	6,  // 5: research.Substate.Account.storage:type_name -> research.Substate.Account.StorageEntry
	1,  // 6: research.Substate.AllocEntry.account:type_name -> research.Substate.Account
	7,  // 7: research.Substate.BlockEnv.block_hashes:type_name -> research.Substate.BlockEnv.BlockHashEntry
	8,  // 8: research.Substate.TxMessage.access_list:type_name -> research.Substate.TxMessage.AccessListEntry
	9,  // 9: research.Substate.Result.logs:type_name -> research.Substate.Result.Log
