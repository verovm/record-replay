...
type Substate struct {
	...
	InputAlloc  []*Substate_AllocEntry `protobuf:"bytes,1,rep,name=input_alloc,json=inputAlloc,proto3" json:"input_alloc,omitempty"`
	OutputAlloc []*Substate_AllocEntry `protobuf:"bytes,2,rep,name=output_alloc,json=outputAlloc,proto3" json:"output_alloc,omitempty"`
	BlockEnv    *Substate_BlockEnv     `protobuf:"bytes,3,opt,name=block_env,json=blockEnv,proto3" json:"block_env,omitempty"`
	TxMessage   *Substate_TxMessage    `protobuf:"bytes,4,opt,name=tx_message,json=txMessage,proto3" json:"tx_message,omitempty"`
	Result      *Substate_Result       `protobuf:"bytes,5,opt,name=result,proto3" json:"result,omitempty"`
}
...
type Substate_Account struct {
	...
	Storage []*Substate_Account_StorageEntry `protobuf:"bytes,3,rep,name=storage,proto3" json:"storage,omitempty"`
...
type Substate_Account_Code struct {
	Code []byte `protobuf:"bytes,4,opt,name=code,proto3,oneof"`
}

type Substate_Account_CodeHash struct {
	CodeHash []byte `protobuf:"bytes,5,opt,name=code_hash,json=codeHash,proto3,oneof"`
}
...
type Substate_AllocEntry struct {
	...
	Account *Substate_Account `protobuf:"bytes,2,opt,name=account,proto3,oneof" json:"account,omitempty"`
}
...
func (x *Substate_BlockEnv) GetBlockHashes() map[uint64][]byte {
	if x != nil {
...
type Substate_TxMessage struct {
	...
	AccessList []*Substate_TxMessage_AccessListEntry `protobuf:"bytes,10,rep,name=access_list,json=accessList,proto3" json:"access_list,omitempty"`
...
type Substate_Result struct {
	...
	Logs            []*Substate_Result_Log `protobuf:"bytes,3,rep,name=logs,proto3" json:"logs,omitempty"`
...
var file_substate_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x72, 0x65, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x22, 0xdf, 0x0d, 0x0a, 0x08, 0x53,
	...
	0x63, 0x6b, 0x5f, 0x65, 0x6e, 0x76, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x72,
	0x65, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x2e, 0x53, 0x75, 0x62, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x72, 0x65, 0x73, 0x65, 0x61, 0x72,
	...
	0x12, 0x31, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x0a, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x1a, 0x6d, 0x0a, 0x0a, 0x41,
	...
	0x65, 0x73, 0x73, 0x12, 0x39, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02,
	...
	0x0a, 0x08, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0xd7, 0x02, 0x0a, 0x08, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x6e, 0x76, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x69, 0x6e, 0x62,
	0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x63, 0x6f, 0x69, 0x6e, 0x62,
	0x61, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74,
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75,
	0x6c, 0x74, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x67, 0x61, 0x73, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x62, 0x61, 0x73, 0x65,
	0x5f, 0x66, 0x65, 0x65, 0x1a, 0xe6, 0x03, 0x0a, 0x09, 0x54, 0x78, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	,
	...
	0x52, 0x0b, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x4b, 0x65, 0x79, 0x73, 0x42, 0x07, 0x0a,
	0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x74, 0x6f, 0x42, 0x0e, 0x0a,
	0x0c, 0x5f, 0x67, 0x61, 0x73, 0x5f, 0x66, 0x65, 0x65, 0x5f, 0x63, 0x61, 0x70, 0x42, 0x0e, 0x0a,
	0x0c, 0x5f, 0x67, 0x61, 0x73, 0x5f, 0x74, 0x69, 0x70, 0x5f, 0x63, 0x61, 0x70, 0x1a, 0xfc, 0x01,
	...
	0x05, 0x62, 0x6c, 0x6f, 0x6f, 0x6d, 0x12, 0x31, 0x0a, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x65, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x2e,
	0x53, 0x75, 0x62, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2e,
	0x4c, 0x6f, 0x67, 0x52, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6e,
	...
	0x72, 0x65, 0x73, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x61, 0x73, 0x5f, 0x75, 0x73, 0x65, 0x64,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x67, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64, 0x1a,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x0d, 0x5a, 0x0b,
	0x2e, 0x2e, 0x2f, 0x72, 0x65, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_substate_proto_goTypes = []interface{}{
	...
	nil,                                        // 7: research.Substate.BlockEnv.BlockHashesEntry
...
var file_substate_proto_depIdxs = []int32{
	...
	7,  // 7: research.Substate.BlockEnv.block_hashes:type_name -> research.Substate.BlockEnv.BlockHashesEntry
...
func file_substate_proto_init() {
	...
	file_substate_proto_msgTypes[2].OneofWrappers = []interface{}{}
